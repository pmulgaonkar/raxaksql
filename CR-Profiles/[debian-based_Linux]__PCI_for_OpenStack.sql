select add_profile_data ('[debian-based Linux] PCI for OpenStack Controller' ,'Profile Customized by CloudRaxak' ,'Linux-based OS','' ,'2015-05-26' ,'Profile by Cloud Raxak') from dual;
select add_rule_data ('default','V-55010','SV-50462r1_rule','default','high','Ensure that the security groups are tied to Neutron groups','Match security groups across OpenStack layers','F-55010','
    Cross check all security groups and compare them with Neutron security groups.
    This must be done manually.
   ' , '[debian-based Linux] PCI for OpenStack Controller','Profile Customized by CloudRaxak','RHEL-06-000276','','Compare and test all security groups.
...
select add_rule_data ('default','V-55011','SV-50462r1_rule','default','high','Encrypt all non-console admin access using strong cryptography','Ensure that SSH, VPN, or SSL/TLS access is enabled. ','F-55000','
   ...
   ' , '[debian-based Linux] PCI for OpenStack Controller','Profile Customized by CloudRaxak','Ubuntu 14.04','','Check that Openssl is enabled.
    ','Customized rule by Cloud Raxak') from dual;
select add_rule_data ('default','V-55012','SV-50462r1_rule','default','high','Use strong cryptography','HASH(0x7ff4f12e72d8)','F-55012','
    Enable certain ciphers and check if openssl shows this as correctly setup.
   ' , '[debian-based Linux] PCI for OpenStack Controller','Profile Customized by CloudRaxak','Ubuntu 14.04','','
...
select add_rule_data ('default','V-55013','SV-50462r1_rule','default','high','
   ...
   ' , '[debian-based Linux] PCI for OpenStack Controller','Profile Customized by CloudRaxak','Ubuntu 14.04','','Determine if the system is capable of trusted boot.
    ','Customized rule by Cloud Raxak') from dual;
select add_rule_data ('default','V-55014','SV-50462r1_rule','default','high','
   ...
   ' , '[debian-based Linux] PCI for OpenStack Controller','Profile Customized by CloudRaxak','Ubuntu 14.04','','Check and report password policies. Is keystone getting
