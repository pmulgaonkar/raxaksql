...
If the value for â€œDevices: Allow Undock Without Having to Log Onâ€? is not set to "Disabledâ€?, then this is a finding.
...
Type: REG_DWORD
Value: 1','Customized rule by Cloud Raxak') from dual;
select add_rule_data ('default','V-16001','SV-32508r2_rule','default','low','The system will be configured to allow only the default client printer to be redirected in the Remote Desktop session. (Remote Desktop Services Role)','This check verifies that the system is configured to allow only the default client printer to be redirected in the Remote Desktop session.','F-28928r1_fix','Configure the policy value for Computer Configuration -> Administrative Templates -> Windows Components -> Remote Desktop Services -> Remote Desktop Session Host -> Printer Redirection â€œRedirect only the default client printerâ€? to â€œEnabledâ€?.' , 'Microsoft Windows Server 2008 R2 DISA-MissionCriticalClassified_2008','Profile Customized by CloudRaxak','5.078','http://oval.mitre.org/XMLSchema/oval-definitions-5','If the following registry value doesnâ€™t exist or is not configured as specified, this is a finding:
...
Type: REG_DWORD
Value: 0  ','Customized rule by Cloud Raxak') from dual;
select add_rule_data ('default','V-21975','SV-32462r1_rule','default','medium','The system will be prevented from joining a homegroup.','This setting will prevent a system from being joined to a homegroup.  Homegroups are a method of sharing data and printers on a home network.','F-22967r1_fix','Configure the policy value for Computer Configuration -> Administrative Templates -> Windows Components -> HomeGroup -> â€œPrevent the computer from joining a homegroupâ€? to â€œEnabledâ€?.' , 'Microsoft Windows Server 2008 R2 DISA-MissionCriticalClassified_2008','Profile Customized by CloudRaxak','5.282','http://oval.mitre.org/XMLSchema/oval-definitions-5','If the following registry value doesnâ€™t exist or is not configured as specified, this is a finding:
