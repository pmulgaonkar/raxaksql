select add_profile_data ('[debian-based Linux] PCI-DSS Compliance (Full)' ,'Profile Customized by CloudRaxak' ,'Linux-based OS','' ,'2015-05-26' ,'Profile by Cloud Raxak') from dual;
...
select add_rule_data ('default','V-38443','SV-50243r1_rule','default','medium','The /etc/gshadow file must be owned by root.','The "/etc/gshadow" file contains group password hashes. Protection of this file is critical for system security.','F-43388r1_fix','Run the below command to change the ownership of "/etc/gshadow" to root:
 ...
 chown root /etc/gshadow' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000036','C-45998r1_chk','To check the ownership of "/etc/gshadow", run the command: 
...
select add_rule_data ('default','V-38449','SV-50249r1_rule','default','medium','The /etc/gshadow file must have mode 0000.','The /etc/gshadow file contains group password hashes. Protection of this file is critical for system security.','F-43394r1_fix','To properly set the permissions of "/etc/gshadow", run the command: 
 ...
 chmod 0000 /etc/gshadow' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000038','C-46004r1_chk','To check the permissions of "/etc/gshadow", run the command: 
...
select add_rule_data ('default','V-38450','SV-50250r1_rule','default','medium','The /etc/passwd file must be owned by root.','The "/etc/passwd" file contains information about the users that are configured on the system. Protection of this file is critical for system security.','F-43395r1_fix','Run the below command to change the ownership of "/etc/passwd" to root:  
 ...
 chown root /etc/passwd' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000039','C-46005r1_chk','To check the ownership of "/etc/passwd", run the command: 
...
select add_rule_data ('default','V-38457','SV-50257r1_rule','default','medium','The /etc/passwd file must have mode 0644 or less permissive.','If the "/etc/passwd" file is writable by a group-owner or the world the risk of its compromise is increased. The file contains the list of accounts on the system and associated information, and protection of this file is critical for system security.','F-43397r1_fix','To properly set the permissions of "/etc/passwd", run the command: 
 ...
 chmod 0644 /etc/passwd' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000041','C-46007r1_chk','To check the permissions of "/etc/passwd", run the command: 
...
select add_rule_data ('default','V-38459','SV-50259r1_rule','default','medium','The /etc/group file must be group-owned by root.','The "/etc/group" file contains information regarding groups that are configured on the system. Protection of this file is important for system security.','F-43404r1_fix','To change the group owner of "/etc/group" to root, run the command: 
 ...
 chgrp root /etc/group' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000043','C-46014r1_chk','To check the group ownership of "/etc/group", run the command: 
...
INFO: minlen should be >= 14 and the credits limit should be less or equal to 0 for the validation criteria in the rule.' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000050','C-46029r1_chk','To check the minimum password length and to check the other settings required for the password authentication, run the command:
...
select add_rule_data ('default','V-38476','SV-50276r3_rule','default','high','Vendor-provided cryptographic certificates must be installed to verify the integrity of system software.','The Red Hat GPG keys are necessary to cryptographically verify packages are from Red Hat. ','F-43421r3_fix','To ensure the system can cryptographically verify base software packages installation. Use the command:
 apt-key update' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000008','C-46031r3_chk','To ensure that the keys are installed, run:
...
$ pwunconv; pwconv' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000051','C-46032r1_chk','To check the minimum password age, run the command: 
...
select add_rule_data ('default','V-38478','SV-50278r2_rule','default','low','The Red Hat Network Service (rhnsd) service must not be running, unless using RHN or an RHN Satellite.','Although systems management and patching is extremely important to system security, management by a system outside the enterprise enclave is not desirable for some environments. However, if the system is being managed by RHN or RHN Satellite Server the "rhnsd" daemon can remain on.','F-43423r2_fix','The Red Hat Network service automatically queries Red Hat Network servers to determine whether there are any actions that should be executed, such as package updates. This only occurs if the system was registered to an RHN server or satellite and managed as such. The "rhnsd" service can be disabled with the following commands: 
 ...
 service rhnsd stop' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000009','C-46033r2_chk','Run the following command to verify "rhnsd" is disabled through current runtime configuration: 
...
$ pwunconv; pwconv' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000053','C-46034r1_chk','To check the maximum password age, run the command: 
...
$ pwunconv; pwconv' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000054','C-46035r1_chk','To check the password warning age, run the command: 
...
Add "dcredit=-1" after pam_cracklib.so in /etc/pam.d/common-password file to require use of a digit in password.' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000056','C-46037r1_chk','To check how many digits are required in a password, run the following command: 
...
select add_rule_data ('default','V-38489','SV-50290r1_rule','default','medium','A file integrity tool aide must be installed.','The AIDE package must be installed if it is to be available for integrity checking.','F-43436r1_fix','Install the aide, aide-common packages with the commands: 
 ...
 apt-get -y install aide-common' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000016','C-46046r1_chk','Run the following command to determine if the "aide", "aide-common" packages are installed: 
...
Note:  Virtual console entries are not limited to those listed above.  Any lines starting with "vc/" followed by numerals should be removed.' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000027','C-46049r1_chk','To check for virtual console entries which permit root login, run the following command: 
...
select add_rule_data ('default','V-38502','SV-50303r1_rule','default','medium','The /etc/shadow file must be owned by root.','The "/etc/shadow" file contains the list of local system accounts and stores password hashes. Protection of this file is critical for system security. Failure to give ownership of this file to root provides the designated owner with access to sensitive information which could weaken the system security posture.','F-43449r1_fix','Run the below command to change the ownership of "/etc/shadow" to root:
 ...
 chown root /etc/shadow' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000033','C-46059r1_chk','To check the ownership of "/etc/shadow", run the command: 
...
select add_rule_data ('default','V-38504','SV-50305r1_rule','default','medium','The /etc/shadow file must have mode 0000.','The "/etc/shadow" file contains the list of local system accounts and stores password hashes. Protection of this file is critical for system security. Failure to give ownership of this file to root provides the designated owner with access to sensitive information which could weaken the system security posture.','F-43451r1_fix','To properly set the permissions of "/etc/shadow", run the command: 
 ...
 chmod 0000 /etc/shadow' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000035','C-46061r2_chk','To check the permissions of "/etc/shadow", run the command: 
...
or restart sysctl.' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000082','C-46068r3_chk','Check if IP forwarding for IPv4 is enabled on the system, by querying the following command: 
...
or restart sysctl' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000088','C-46086r3_chk','Check if the system is configured to log Martian packets, by querying the following command:
...
or restart sysctl.' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000089','C-46088r2_chk','Check if system is configured to reject IPv4 source-routed packets by default, by running the following command:
...
or restart sysctl.' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000090','C-46089r2_chk','Check if the system is configured to reject ICMPv4 secure redirect packets by default, by querying the following command: 
...
or restart sysctl.' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000091','C-46091r2_chk','Check if the system is configured to ignore ICMPv4 redirect messages by default, by querying the following command: 
...
or restart sysctl.' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000092','C-46093r2_chk','The status of the "net.ipv4.icmp_echo_ignore_broadcasts" kernel parameter can be queried by running the following command:
...
or restart sysctl.' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000093','C-46095r2_chk','The status of the "net.ipv4.icmp_ignore_bogus_error_responses" kernel parameter can be queried by running the following command:
...
or restart sysctl.' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000095','C-46097r2_chk','Check if the system is configured to use TCP syncookies when experiencing a TCP SYN flood, by querying the following command:
...
or restart sysctl.' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000096','C-46100r2_chk','Check if system is configured to use the reverse-path filter for IPv4 network traffic on all interfaces enabled
...
or restart sysctl.' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000099','C-46106r3_chk','Check if IPv6 module is enabled or not using the following command :
...
Add "ucredit=-1" after pam_cracklib.so in /etc/pam.d/common-password file to require use of an uppercase character in a password.' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000057','C-46127r1_chk','To check how many uppercase characters are required in a password, run the following command: 
...
Add "lcredit=-1" after pam_cracklib.so in /etc/pam.d/common-password file to require use of a lowercase character in password.' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000059','C-46129r1_chk','To check how many lowercase characters are required in a password, run the following command: 
...
select add_rule_data ('default','V-38579','SV-50380r1_rule','default','medium','The system boot loader configuration file(s) must be owned by root.','Only root should be able to modify important boot parameters.','F-43527r1_fix','The file "/etc/default/grub" should be owned by the "root" user to prevent destruction or modification of the file. To change the owner of "/etc/default/grub" to root, run the command: 
 ...
 chown root /etc/default/grub' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000065','C-46137r1_chk','To check the ownership of "etc/default/grub", run the command:
...
Boot partitions based on VFAT, NTFS, or other non-standard configurations may require alternative measures.' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000067','C-46141r2_chk','To check the permissions of /boot/grub/grub.cfg, run the command:
...
select add_rule_data ('default','V-38584','SV-50385r1_rule','default','low','The xinetd service must be uninstalled if no network services utilizing it are enabled.','Removing the "xinetd" package decreases the risk of the xinetd service"s accidental (or intentional) activation.','F-43532r1_fix','The "xinetd" package can be uninstalled with the following command: 
 ...
 dpkg -r --force-all xinetd' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000204','C-46142r1_chk','If network services are using the xinetd service, 
...
Mitigation:  If the telnet-server package is configured to only allow encrypted sessions, such as with Kerberos or the use of encrypted network tunnels, the risk of exposing sensitive information is mitigated.','F-43535r1_fix','The "telnetd" package can be uninstalled with the following command: 
 ...
 dpkg -r --force-all telnetd' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000206','C-46144r1_chk','Run the following command to determine if the "telnetd" package is installed: 
...
select add_rule_data ('default','V-38591','SV-50392r1_rule','default','high','The rsh-server package must not be installed.','The "rsh-server" package provides several obsolete and insecure network services. Removing it decreases the risk of those services" accidental (or intentional) activation.','F-43539r1_fix','The "rsh-server" package can be uninstalled with the following command: 
 ...
 dpkg -r --force-all rsh-server' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000213','C-46149r1_chk','Run the following command to determine if the "rsh-server" package is installed: 
...
Note that any updates made to "/etc/pam.d/common-auth" may be overwritten by the "authconfig" program.  The "authconfig" program should not be used.' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000356','C-46151r5_chk','To ensure the failed password attempt policy is configured correctly, run the following command: 
...
$ service ssh restart' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000073','C-46150r1_chk','To check if the system login banner is compliant, run the following command: 
...
or restart sysctl.' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000078','C-46153r2_chk','Check if the system is configured to implement virtual address space randomization, by querying the following command:
...
Restart the vsftpd daemon.
 ...
 service vsftpd restart' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000348','C-46174r1_chk','If vstfpd service is not installed on the system, this rule is not applicable.
...
or restart sysctl.' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000081','C-46159r2_chk','Check if system sends ICMPv4 redirects from any interface, by querying the following command:
...
(Since ypserv is nis in ubuntu so there is no separate package for ypserv. Hence, we are removing nis package.)
   ' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000220','C-46161r1_chk','Run the following command to determine if the "nis" package is installed: 
...
select add_rule_data ('default','V-38604','SV-50405r2_rule','default','medium','The ypbind service must not be running.','Disabling the "ypbind" service ensures the system is not acting as a client in a NIS or NIS+ domain.','F-43552r2_fix','The "ypbind" service, which allows the system to act as a client in a NIS or NIS+ domain, should be disabled. The "ypbind" service can be disabled with the following commands: 
 ...
 service ypbind stop
 sysv-rc-conf --level 0123456S ypbind off' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000221','C-46162r2_chk','Run the following command to verify "ypbind" is disabled through current runtime configuration: 
...
select add_rule_data ('default','V-38605','SV-50406r2_rule','default','medium','The cron service must be running.','Due to its usage for maintenance and security-supporting tasks, enabling the cron daemon is essential.','F-43553r2_fix','The "cron" service is used to execute commands at preconfigured times. It is required by almost all systems to perform necessary maintenance tasks, such as notifying root of system activity. The "cron" service can be enabled with the following commands: 
 ...
 service cron start' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000224','C-46163r1_chk','Run the following command to determine the current status of the "crond" service: 
...
If tftpd is not installed the check for tftpd-hpa package, to remove run following command:
 ...
 dpkg -r --force-all tftpd-hpa
   ' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000222','C-46164r1_chk','Run the following command to determine if the "tftpd" package is installed: 
...
$ service ssh restart
' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000227','C-46165r1_chk','To check which SSH protocol version is allowed, run the following command: 
...
$ service ssh restart' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000231','C-46168r1_chk','To ensure the SSH idle timeout will occur when the "ClientAliveCountMax" is set, run the following command: 
...
$ service ssh restart' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000230','C-46167r1_chk','Run the following command to see what the timeout interval is: 
...
The "tftpd-hpa" service can be disabled with the following commands:
 ...
 service tftpd-hpa stop
   ' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000223','C-46166r2_chk','To check that the "TFTP" service is disabled, follow the folllowing step:
Check the tftp configuration file:
$ sudo grep -w /usr/sbin/in.tftpd /etc/xinetd.d/*
...
$ service ssh restart' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000234','C-46169r1_chk','To determine how the SSH daemon"s "IgnoreRhosts" option is set, run the following command: 
...
$ service ssh restart' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000236','C-46170r1_chk','To determine how the SSH daemon"s "HostbasedAuthentication" option is set, run the following command: 
...
4. User account password  must be set or RSA key­pairs should be configured.' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000237','C-46171r1_chk','To determine how the SSH daemon"s "PermitRootLogin" option is set, run the following command: 
...
$ service ssh restart' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000239','C-46172r1_chk','To determine how the SSH daemon"s "PermitEmptyPasswords" option is set, run the following command: 
...
Another section contains information on how to create an appropriate system-wide warning banner.' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000240','C-46173r1_chk','To determine how the SSH daemon"s "Banner" option is set, run the following command: 
...
$ service ssh restart' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000241','C-46175r1_chk','To ensure users are not able to present environment daemons, run the following command: 
...
$ service ssh restart' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000243','C-46176r1_chk','Only FIPS-approved ciphers should be used. To verify that only FIPS-approved ciphers are in use, run the following command: 
...
select add_rule_data ('default','V-38618','SV-50419r2_rule','default','low','The avahi service must be disabled.','Because the Avahi daemon service keeps an open network port, it is subject to network attacks. Its functionality is convenient but is only appropriate if the local network can be trusted.','F-43567r2_fix','The "avahi-daemon" service can be disabled with the following commands: 
 ...
 service avahi-daemon stop' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000246','C-46177r1_chk','Run the following command to verify "avahi-daemon" is disabled through current runtime configuration:
...
$ service ntp restart' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000248','C-46180r1_chk','To verify the "ntpd" package is installed on the system, run the following command: 
...
inet_interfaces = localhost' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000249','C-46182r2_chk','If the system is an authorized mail relay host, this is not applicable. 
...
1        5        cron.daily        run-parts --report /etc/cron.daily' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000138','C-46183r1_chk','Run the following commands to determine the current status of the "logrotate" configuration.
...
Set the idle time-out value for global users with the follwoing command:
 ...
 sudo -u UserName -H dbus-launch gsettings set org.gnome.desktop.screensaver lock-delay 300' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000257','C-46188r3_chk','If the system is NON-GUI based system, this is not applicable.
...
umask 077' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000344','C-46207r1_chk','Verify the "umask" setting is configured correctly in the "/etc/profile" file by running the following command:
...
umask 077' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000342','C-46211r1_chk','Verify the "umask" setting is configured correctly in the "/etc/bash.bashrc" file by running the following command:
...
The requirement is 24 passwords.' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000274','C-46219r1_chk','To verify the password reuse setting is compliant, run the following command: 
...
Configure the virus scanning software to perform scans dynamically on all accessed files. If this is not possible, configure the system to scan all altered files on the system on a daily basis. If the system processes inbound SMTP mail, configure the virus scanner to scan all received mail. ' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000284','C-46226r2_chk','Check if "McAfeeVSEForLinux" is installed on the system,
...
$ aideinit ' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000285','C-46227r1_chk','Inspect the system to determine if intrusion detection software has been installed. Verify the intrusion detection software is active by using apparmor or aide tools.
...
AIDE can be executed periodically through other means; this is merely one example.' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000306','C-46229r2_chk','To determine that periodic AIDE execution has been scheduled, run the following command: 
...
To reflect the changes reboot the system.' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000290','C-46234r1_chk','To verify x-windows is disable check following parameter in /etc/default/grub file:
GRUB_CMDLINE_LINUX="text"
GRUB_TERMINAL=console
...
select add_rule_data ('default','V-38676','SV-50477r2_rule','default','low','The xorg-x11-server-common (X Windows) package must not be installed, unless required.','Unnecessary packages should not be installed to decrease the attack surface of the system.','F-43625r1_fix','Removing all packages which constitute the X Window System ensures users or malicious software cannot start X. To do so, run the following command: 
 ...
 apt-get -y purge xserver-common' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000291','C-46236r1_chk','To ensure the X Windows package group is removed, run the following command: 
...
To display a banner, this setting must be enabled and then banner text must also be set.' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000324','C-46250r3_chk','If the system is NON-GUI based system, this is not applicable.
...
"I"ve read AND consent to terms in IS user agreem"t."' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000326','C-46252r3_chk','If the system is NON-GUI based system, this is not applicable.
...
A value of 35 is recommended. If a password is currently on the verge of expiration, then 35 days remain until the account is automatically disabled. However, if the password will not expire for another 60 days, then 95 days could elapse until the account would be automatically disabled. See the "useradd" man page for more information. Determining the inactivity timeout must be done with careful consideration of the length of a "normal" period of inactivity for users in the particular environment. Setting the timeout too low incurs support costs and also has the potential to impact availability of the system to legitimate users.' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000335','C-46256r1_chk','To verify the "INACTIVE" setting, run the following command: 
...
AIDE can be executed periodically through other means; this is merely one example.' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000302','C-46257r2_chk','To determine that periodic AIDE execution has been scheduled, run the following command: 
...
AIDE can be executed periodically through other means; this is merely one example.' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000303','C-46258r2_chk','To determine that periodic AIDE execution has been scheduled, run the following command: 
...
To set the sticky bit on a world-writable directory [], run the following command: 
 ...
 chmod +t [DIR]' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000336','C-46259r4_chk','To find world-writable directories that lack the sticky bit, run the following command for each local partition []: 
...
select add_rule_data ('default','V-51337','SV-65547r1_rule','default','medium','The system must use a Linux Security Module at boot time.','Disabling a major host protection feature, such as SELinux, at boot time prevents it from confining system services at boot time. Further, it increases the chances that it will remain off during system operation.','F-56147r1_fix','The linux security module apparmor can be disabled at boot time by an argument in "/etc/default/grub". Remove any instances of "apparmor=0" or "security=selinux" from the kernel arguments in that file to prevent apparmor from being disabled at boot. And update the grub
 update-grub
   ' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000017','C-54007r1_chk','Inspect "/etc/default/grub" for any instances of "apparmor=0" or "security=selinux" in the kernel boot arguments. Presence of "apparmor=0" or "security=selinux" indicates that apparmor is disabled at boot time. 
...
AIDE can be executed periodically through other means; this is merely one example.' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000307','C-46232r2_chk','To determine that periodic AIDE execution has been scheduled, run the following command: 
...
select add_rule_data ('default','V-51363','SV-65573r1_rule','default','medium','The system must use a Linux Security Module configured to enforce limits on system services.','Setting the SELinux state to enforcing ensures SELinux is able to confine potentially compromised processes to the security policy, which is designed to prevent them from causing damage to the system or further elevating their privileges. ','F-56165r1_fix','Change the profile modules to enforcing by run the following command:
 ...
 aa-enforce /etc/apparmor.d/*
   ' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000020','C-53703r1_chk','Run the following command to check the security module is set with “enforcing�? 
...
If this check produces any unexpected output, investigate. ' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000018','C-53727r1_chk','To find the location of the AIDE database file, run the following command:
...
','
   ...
   ' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000276','','
...
or restart sysctl.' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000276','','Check whether fs.suid_dumpable = 0 using the below command: 
...
apt-get purge selinux-basics' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000276','','The setroubleshoot functionality is actually provided by the packages mentioned below.
...
ks.
   ' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','Ubuntu 14.04','','
...
','F-56028','If installed on system, remove the talk-server package by running:
 apt-get purge talkd' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000276','','Check whether talkd is installed on system:
 dpkg -s talkd
...
','F-56029','If installed on system, remove the talk package by running:
 apt-get purge talk' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000276','','Check whether talk is installed on system:
 dpkg -s talk
If a line with package name and version is returned, this is a finding.','Customized rule by Cloud Raxak') from dual;
...
','F-56030','If installed on system, remove the snmpd package by running:
 ...
 apt-get purge snmpd' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000276','','Check whether snmpd is installed on system:
 dpkg -s snmpd
If a line with package name and version is returned, this is a finding.','Customized rule by Cloud Raxak') from dual;
...
','F-56033','If installed on system, remove the policycoreutils package by running:
 apt-get purge policycoreutils' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000276','','Policycoreutils is a package that provides translation services.
...
','F-56034','If installed on system, remove the apache2 package by running:
 apt-get purge apache2' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000276','','Check whether apache2 is installed on system:
 dpkg -s apache2
If a line with package name and version is returned, this is a finding.','Customized rule by Cloud Raxak') from dual;
...
','F-56035','If installed on system, remove the squid3 package by running:
 apt-get purge squid3' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000276','','Check whether squid3 is installed on system:
 dpkg -s squid3
If a line with package name and version is returned, this is a finding.','Customized rule by Cloud Raxak') from dual;
...
Remove the package by running.
 ...
 apt-get purge []' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000276','','Check for all dovecot packages in the system.
...
','F-56037','If installed on system, remove the bind9 package by running:
 apt-get purge bind9' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000276','','Check whether bind9 is installed on system:
 dpkg -s bind9
If a line with package name and version is returned, this is a finding.','Customized rule by Cloud Raxak') from dual;
...
' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000276','','Run the following command to verify "cups" is disabled through current runtime configuration:
...
To verify if operating system is of the latest version run commands below:
 ...
 /usr/bin/do-release-upgrade -p
If "No new release found" is output, then tere are no updates available for latest OS release
','Customized rule by Cloud Raxak') from dual;
...
','F-55014','
Please check and deactivate any wireless interface manually.' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000276','','
...
','F-55014','Review the list of utilities installed on system and make sure they are legitimate.' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000276','','To check utilities on the system run:
 basename -a $(dpkg -L $(dpkg --list |grep -i utilities|cut -d" " -f3) |egrep "/s?bin/")
...
','
Ensuring that all the packages installed on system are legitimate is like scanning for any third party package. Even if it is installed, the SySadmin can review and veify that it is legitimate.
','F-55014','
...
Remove those audit events which are not required as doing this can save disk space and prevent it from logging activities which are not required.' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000276','','List out all the audit events configured on the system by running:
 auditctl -l
...
To check DNS address used, run:
 ...
 cat /etc/network/interfaces | grep -w dns-nameservers | grep -v "^"
...
','F-56063','Rsyslog is the system logger. It helps in logging all the crucial activity of linux systems. Install it by running:
 apt-get -y install rsyslog' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000276','','Check whether rsyslog is installed on system:
 dpkg -s rsyslog
...
','
Rsyslog service has evolved into a rocket fast system logging. User can control all the logs from /etc/rsyslog.conf, i.e include logs, exclude logs, enable logging, disa
ble logging. This configuration should be reviewed by the SysAdmin.
','F-55014','Review the system wide configuration and make sure that it is legitimate. Check the following things whether modules are loaded properly, system logs are included, log-server ip is set properly, etc.' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000276','','To check configuration of Rsyslog service run:
...
If the rsyslog version being used is lower than 6 add the following text in /etc/default/rsyslog


RSYSLOGD_OPTIONS="-c 5 -r"' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000276','','To ensure logs are sent to a remote host, examine the file "/etc/rsyslog.conf". If using UDP, a line similar to the following should be present:
 *.* @[]
...
the rsyslog options have to be checked.

 grep -w RSYSLOGD_OPTIONS /etc/default/rsyslog | grep -v "^"
...
If anacron service is not installed then install it with the below command:
...
Remove the package by running.
 ...
 apt-get purge "package-name"' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000276','','Check for all dhcp packages in the system.
...
or restart sysctl.' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000276','','To check that the IPv6 Redirects Acceptance is disabled, run the following command: 
...
or restart sysctl.' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000276','','To check that the "IPv6" Router Advertisements are disabled, run the following command:
...
','F-56075','If installed on system, remove the vsftpd package by running:
 apt-get purge vsftpd' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000276','','Check whether vsftpd is installed on system:
 dpkg -s vsftpd
If a line with package name and version is returned, this is a finding.','Customized rule by Cloud Raxak') from dual;
...
','F-56076','If installed on system, remove the samba package by running:
 apt-get purge samba' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000276','','Check whether samba is installed on system:
 dpkg -s samba
If a line with package name and version is returned, this is a finding.','Customized rule by Cloud Raxak') from dual;
...
','F-56077','If installed on system, remove the telnet package by running:
 apt-get purge telnet' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000276','','Check whether telnet is installed on system:
 dpkg -s telnet
If a line with package name and version is returned, this is a finding.','Customized rule by Cloud Raxak') from dual;
...
','F-56078','If installed on system, remove the tftp package by running:
 apt-get -y remove tftp

For tftp-hpa, run following command:

 apt-get -y remove tftp-hpa
   ' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000276','','Check whether tftp is installed on system:
 dpkg -s tftp

For tftp-hpa package
 dpkg -s tftp-hpa

If a line with package name and version is returned, this is a finding.
   ','Customized rule by Cloud Raxak') from dual;
select add_rule_data ('default','V-56079','SV-50462r1_rule','default','high','
The echo-dgram daemon must be disabled.
','
The Echo Protocol is a service in the Internet Protocol Suite defined in RFC 862.
A host may connect to a server that supports the Echo Protocol using the Transmission Control Protocol (TCP) or the User Datagram Protocol (UDP) on the well-known port number 7. The server sends back an identical copy of the data it received.It is recommended that this service be disabled.
   ','F-56079','
The "echo-dgram" service can be disabled through xinetd,
Update "disable = yes" in the xinetd.d service file.

Restart the xinetd service
 service xinetd restart

If the service is configured using inetd then comment out the echo service configuration line for UDP port in /etc/inetd.conf file.
...
Finding the echo service port value at udp protocol.
 sudo grep -w ^echo /etc/services | cut -f3 | grep -w udp | grep -v "^\s*"

example output :- 7/udp

Checking if echo-dgram service port is enabled at udp protocol using below command:-
 netstat -aunp | grep xinetd | grep :7 | grep udp

if service is running at udp port, this is finding. 

If echo service is configured using inetd, run following command:

 grep echo /etc/inetd.conf | grep udp |grep -v "^\s*"
...
[]
   ' , '[debian-based Linux] PCI-DSS Compliance (Full)','Profile Customized by CloudRaxak','RHEL-06-000528','C-58279r1_chk','
